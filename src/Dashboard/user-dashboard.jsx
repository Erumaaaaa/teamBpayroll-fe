...
// Data karyawan yang akan ditampilkan di dashboard
const employeeData = [
...
// Data distribusi jabatan untuk chart
...
// Data payroll bulanan untuk grafik
const payrollData = [
...
// Komponen utama untuk dashboard pengguna
const UserDashboard = () => {
  const [selectedTab, setSelectedTab] = useState(0); // State untuk tab yang dipilih
                      ...
                      <TableRow key={employee.id}>
                        <TableCell className="font-medium">
                          <div className="flex items-center space-x-3">
                            <Avatar>
                            <AvatarImage src="/path/to/actual-image.png" alt={employee.nama} />
